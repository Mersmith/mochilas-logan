...
new #[Title('Nueva Serie')] class extends Component {
    ...
    public function guardar()
    {
        ...
        Flux::toast(variant: 'success', text: 'Serie creada correctamente.');
...
<div class="space-y-6 max-w-4xl mx-auto">
    <div class="flex items-center justify-between">
        <div>
            <flux:heading size="xl">{{ __('Nueva Serie') }}</flux:heading>
            <flux:subheading>{{ __('Registra una nueva serie y su correlativo.') }}</flux:subheading>
        </div>
