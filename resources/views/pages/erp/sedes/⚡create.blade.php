...
new #[Title('Nueva Sede')] class extends Component {
    ...
    public function guardar()
    {
        ...
        Flux::toast(variant: 'success', text: 'Sede creada correctamente.');
...
<div class="space-y-6 max-w-4xl mx-auto">
    <div class="flex items-center justify-between">
        <div>
            <flux:heading size="xl">{{ __('Nueva Sede') }}</flux:heading>
            <flux:subheading>{{ __('Registra una nueva sede para el sistema.') }}</flux:subheading>
        </div>
