...
new #[Title('Editar Unidad de Medida')] class extends Component {
    ...
    public function mount(UnidadMedida $unidadMedida)
    {
        ...
        $this->abreviacion = $unidadMedida->abreviacion;
        $this->activo = $unidadMedida->activo;
    }
...
<div class="space-y-6 max-w-2xl mx-auto">
    <div class="flex items-center justify-between">
        <div>
            <flux:heading size="xl">{{ __('Editar Unidad') }}</flux:heading>
            <flux:subheading>{{ __('Modifica los datos de la unidad de medida.') }}</flux:subheading>
        </div>
