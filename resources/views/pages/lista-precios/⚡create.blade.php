...
new #[Title('Nueva Lista de Precios')] class extends Component {
...
<div class="space-y-6 max-w-2xl mx-auto">
    <div class="flex items-center justify-between">
        <div>
            <flux:heading size="xl">{{ __('Nueva Lista') }}</flux:heading>
            <flux:subheading>{{ __('Registra una nueva lista de precios.') }}</flux:subheading>
        </div>
