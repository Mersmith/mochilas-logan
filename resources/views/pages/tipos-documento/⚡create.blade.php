...
new #[Title('Nuevo Tipo de Documento')] class extends Component {
    ...
    public function guardar()
    {
        ...
        Flux::toast(variant: 'success', text: 'Tipo de Documento creado correctamente.');
...
<div class="space-y-6 max-w-4xl mx-auto">
    <div class="flex items-center justify-between">
        <div>
            <flux:heading size="xl">{{ __('Nuevo Tipo de Documento') }}</flux:heading>
            <flux:subheading>{{ __('Registra un nuevo tipo de documento para el sistema.') }}</flux:subheading>
        </div>
